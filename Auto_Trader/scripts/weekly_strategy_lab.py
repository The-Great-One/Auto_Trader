...
# (signal handlers + atexit registered in __main__ guard below)

# --- End process cleanup guard (definitions only; patching in __main__) ---

if __name__ == "__main__":
    # Register signal handlers + atexit + ProcessPoolExecutor patch (main process only)
