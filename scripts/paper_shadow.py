...
def run_equity_shadow() -> dict:
    ...
    payload = {
        ...
        "equity_entry_diagnostics": {
            ...
            "hard_block_count": entry_details.get("hard_block_count"),
            ...
            "readiness_score_pct": entry_details.get("readiness_score_pct"),
            "score_gap_to_buy": entry_details.get("score_gap_to_buy"),
            "blocker_pressure": entry_details.get("blocker_pressure", {}),
            "blocker_margins": entry_details.get("blocker_margins", {}),
